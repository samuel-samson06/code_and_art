    ...
    <div>
      <div className=" max-sm:flex-col items-center bg-black justify-evenly max-sm:py-10 py-14 text-white flex">
        <main className="text-5xl max-sm:text-3xl">
          <p className=" font-architect text-7xl max-sm:text-5xl"><span className=" font-serif">I</span> AM</p>
          <p className=" font-architect pb-3">FRANK DIBA</p>
          <p className=" font-fredoka leading-5 text-[12px] max-sm:text-sm max-sm:pb-5">Frank Chibuike Nwokediba <br />Artist | Concept designer | Creative Director</p>
        </main>
        <aside>
