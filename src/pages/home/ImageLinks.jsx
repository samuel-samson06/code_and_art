  ...
  return (
    <React.Fragment>
        <div className=' md:grid-cols-4 md:gap-12 md:mx-10 items-center grid grid-cols-2 place-items-center  py-10 text-white text-center sm:gap-8 gap-6'>
            <NavLink to={"/canvas"} className={`  cursor-pointer relative flex flex-col items-center w-32 sm:w-36 md:w-40`}>
            ...
            <NavLink to={"/exhibit"} className={`  cursor-pointer relative flex flex-col items-center w-32 sm:w-36 md:w-40`}>
            ...
            <NavLink to={"/merch"} className={`  cursor-pointer relative flex flex-col items-center w-32 sm:w-36 md:w-40`}>
            ...
            <NavLink to={"/collectibles"} className={`  cursor-pointer relative flex flex-col items-center w-32 sm:w-36 md:w-40`}>
