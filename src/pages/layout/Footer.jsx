    ...
    <React.Fragment>
      <footer className=" bg-gray-50 py-5">  
        <div className=" border-[1px] rounded-md py-2 flex flex-col gap-3 mx-4 border-gray-300">
          <footer>
            <h1 className=" text-center">Secured by <b>paystack</b></h1>
          </footer>
          <section className=" grid grid-cols-4 justify-items-center items-center">
        ...
        <nav className=" flex items-center justify-between px-3 pt-10 pb-2">
          ...
          <div className=" flex items-center">
            ...
            <p className=" text-[12px]">&copy; Copyright <span className=" font-semibold">{year.getFullYear()}</span></p>
          </div>
        </nav>
      </footer>
    </React.Fragment>
